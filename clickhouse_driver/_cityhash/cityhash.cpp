...
/* "clickhouse_driver/_cityhash/cityhash.pyx":46
 * 
 * 
 ...
 * 
*/
  __pyx_t_3 = __Pyx_PyUnicode_Unicode(__pyx_v_argname); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_FormatSimpleAndDecref(PyObject_Str(__pyx_v_expected), __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_FormatSimpleAndDecref(PyObject_Str(((PyObject *)Py_TYPE(__pyx_v_value))), __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 49, __pyx_L1_error)
...
static PyObject *__pyx_f_17clickhouse_driver_9_cityhash_8cityhash_CityHash128(PyObject *__pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "clickhouse_driver/_cityhash/cityhash.pyx":58
 *     cdef object obj
...
*/
    __pyx_t_2 = PyUnicode_AsUTF8String(__pyx_v_data); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 59, __pyx_L1_error)
 ...
 *         Py_DECREF(obj)
*/
    __pyx_t_3 = PyObject_GetBuffer(__pyx_v_obj, (&__pyx_v_buf), PyBUF_SIMPLE); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(0, 60, __pyx_L1_error)

    /* "clickhouse_driver/_cityhash/cityhash.pyx":61
 *         obj = PyUnicode_AsUTF8String(data)
 *         PyObject_GetBuffer(obj, &buf, PyBUF_SIMPLE)
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)             # <<<<<<<<<<<<<<
 *         Py_DECREF(obj)
...
*/
    ...
    /* "clickhouse_driver/_cityhash/cityhash.pyx":62
 *         PyObject_GetBuffer(obj, &buf, PyBUF_SIMPLE)
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)
 *         Py_DECREF(obj)             # <<<<<<<<<<<<<<
 *     elif PyBytes_Check(data):
...
*/
  ...
  /* "clickhouse_driver/_cityhash/cityhash.pyx":63
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)
 *         Py_DECREF(obj)
 *     elif PyBytes_Check(data):             # <<<<<<<<<<<<<<
 *         result = c_CityHash128(<const char*>PyBytes_AS_STRING(data),
...
*/
  ...
  if (__pyx_t_1) {
    ...
    /* "clickhouse_driver/_cityhash/cityhash.pyx":64
 *         Py_DECREF(obj)
 *     elif PyBytes_Check(data):
 *         result = c_CityHash128(<const char*>PyBytes_AS_STRING(data),             # <<<<<<<<<<<<<<
 *                                PyBytes_GET_SIZE(data))
...
*/
  ...
  /* "clickhouse_driver/_cityhash/cityhash.pyx":66
 *         result = c_CityHash128(<const char*>PyBytes_AS_STRING(data),
 *                                PyBytes_GET_SIZE(data))
 *     elif PyObject_CheckBuffer(data):             # <<<<<<<<<<<<<<
...
*/
  ...
  if (likely(__pyx_t_1)) {
    ...
    /* "clickhouse_driver/_cityhash/cityhash.pyx":67
 *                                PyBytes_GET_SIZE(data))
 *     elif PyObject_CheckBuffer(data):
 *         PyObject_GetBuffer(data, &buf, PyBUF_SIMPLE)             # <<<<<<<<<<<<<<
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)
 *     else:
*/
    __pyx_t_3 = PyObject_GetBuffer(__pyx_v_data, (&__pyx_v_buf), PyBUF_SIMPLE); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(0, 67, __pyx_L1_error)

    /* "clickhouse_driver/_cityhash/cityhash.pyx":68
 *     elif PyObject_CheckBuffer(data):
 *         PyObject_GetBuffer(data, &buf, PyBUF_SIMPLE)
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)             # <<<<<<<<<<<<<<
 *     else:
...
*/
  ...
  /* "clickhouse_driver/_cityhash/cityhash.pyx":70
 *         result = c_CityHash128(<const char*>buf.buf, buf.len)
 *     else:
 *         raise _type_error("data", ["bytes", "str", "buffer"], data)             # <<<<<<<<<<<<<<
...
*/
  /*else*/ {
    ...
    if (__Pyx_PyList_SET_ITEM(__pyx_t_2, 0, __pyx_mstate_global->__pyx_n_u_bytes) != (0)) __PYX_ERR(0, 70, __pyx_L1_error);
    __Pyx_INCREF(__pyx_mstate_global->__pyx_n_u_str);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_n_u_str);
    if (__Pyx_PyList_SET_ITEM(__pyx_t_2, 1, __pyx_mstate_global->__pyx_n_u_str) != (0)) __PYX_ERR(0, 70, __pyx_L1_error);
    __Pyx_INCREF(__pyx_mstate_global->__pyx_n_u_buffer);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_n_u_buffer);
    if (__Pyx_PyList_SET_ITEM(__pyx_t_2, 2, __pyx_mstate_global->__pyx_n_u_buffer) != (0)) __PYX_ERR(0, 70, __pyx_L1_error);
    __pyx_t_4 = __pyx_f_17clickhouse_driver_9_cityhash_8cityhash__type_error(__pyx_mstate_global->__pyx_n_u_data, __pyx_t_2, __pyx_v_data); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  ...
  /* "clickhouse_driver/_cityhash/cityhash.pyx":71
 *     else:
 *         raise _type_error("data", ["bytes", "str", "buffer"], data)
 *     return 0x10000000000000000 * int(result.first) + int(result.second)             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __pyx_t_5 = __Pyx_PyLong_From_uint64_t(__pyx_v_result.first); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = 1;
  {
  ...
  __pyx_t_5 = PyNumber_Multiply(__pyx_mstate_global->__pyx_int_0x10000000000000000, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_7 = __Pyx_PyLong_From_uint64_t(__pyx_v_result.second); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_6 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_2, __pyx_t_7};
  ...
  __pyx_t_7 = PyNumber_Add(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_r = __pyx_t_7;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "CityHash128", 0) < (0)) __PYX_ERR(0, 53, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("CityHash128", 1, 1, 1, i); __PYX_ERR(0, 53, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("CityHash128", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 53, __pyx_L3_error)
  __pyx_L6_skip:;
...
static PyObject *__pyx_pf_17clickhouse_driver_9_cityhash_8cityhash_CityHash128(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_data) {
  ...
  __Pyx_RefNannySetupContext("CityHash128", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_17clickhouse_driver_9_cityhash_8cityhash_CityHash128(__pyx_v_data, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
*/
  ...
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_CityHash128, __pyx_t_2) < (0)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
